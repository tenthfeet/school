<x-app-layout>
    ...
    <div class="grid grid-cols-1 gap-6">
        <div class="card">
            <div class="card-body flex flex-col p-6">
                <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                    <div class="flex-1">
                        <div class="card-title text-slate-900 dark:text-white">Add new Exam Category</div>
                    </div>
                </header>
                <div class="card-text h-full">
                    <form class="space-y-4" id="exam-category-form">
                        @csrf
        ...
        <div class="card">
            <div class="card-header card-title">List of Exam Categories</div>
            <div class="card-body">
