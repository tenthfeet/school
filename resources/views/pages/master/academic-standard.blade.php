<x-app-layout>
    ...
    <div class="card mb-3">
        <div class="card-header card-title">Add new Academic Standard </div>
        <div class="card-body">
    ...
    <div class="card">
        <div class="card-header card-title">List of Academic Standards</div>
        <div class="card-body">
            <div class="inline-block min-w-full align-middle">
                <div class="overflow-hidden">
                    <table id="lists" class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
