<x-app-layout>
    <x-slot:breadcrumb> Language </x-slot:breadcrumb>

    <div class="card mb-3">
        <div class="card-header card-title">Add new Language </div>
        <div class="card-body">
    ...
    <div class="card">
        <div class="card-header card-title">List of Languages</div>
        <div class="card-body">
                    ...
                    <table id="lists"
                        ...
                        <thead class="border-t border-slate-100 dark:border-slate-800">
                            <tr class="table-primary">
                                ...
                                <th scope="col" class="table-th border border-slate-100 dark:bg-slate-800 dark:border-slate-700">Language</th>
    ...
    <x-slot:script>
        @vite('resources/js/pages/master/language.js')
    </x-slot:script>
