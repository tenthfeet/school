<x-app-layout>
    ...
    <div class="card mb-3">
        <div class="card-header card-title">Add new State </div>
        <div class="card-body">
            <form id="state-form">
                @csrf
    ...
    <div class="card">
        <div class="card-header card-title">List of States</div>
        <div class="card-body">
                    ...
                    <table id="lists"
                        ...
                        <thead class="border-t border-slate-100 dark:border-slate-800">
                            <tr class="table-primary">
                                ...
                                <th scope="col" class="table-th border border-slate-100 dark:bg-slate-800 dark:border-slate-700">State Code</th>
